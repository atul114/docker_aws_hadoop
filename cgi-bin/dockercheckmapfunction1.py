...
di=g.read()
g.close()
u1=str(data.getvalue('1'))
u2=str(data.getvalue('2'))
#print u1
#print pi
...
print '<pre><b>'
print commands.getoutput(" sudo docker exec "+di+' hadoop jar /usr/share/hadoop/hadoop-examples-1.2.1.jar wordcount '+u1+' '+u2)
print '</b></pre>'
print '<h1><u><center><span style="color:green">HERE IS THE COUNT </span></u>:-</center></h1>'
print '<pre>'
print '<span style="color:blue">'
print commands.getoutput(" sudo docker exec "+di+' hadoop fs -cat '+u2+'/part-r-00000')
print '</span>'
print '</pre>'
