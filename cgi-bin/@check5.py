...
def two():
	print "oo"
	print '<form method="post" action="/cgi-bin/@checkfunction2.py">'
...
def three():
	print "oo"
	print '<form method="post" action="/cgi-bin/@checkfunction3.py">'
...
def four():
	...
	print '<pre>'
	print commands.getoutput(" sudo ssh -o StrictHostKeyChecking=no -i /root/Downloads/2ndjune.pem ec2-user@"+pi+' sudo -i hdfs dfsadmin -safemode enter')
	print '</pre>'
...
def ten():
	print '<pre>'
	kk=commands.getoutput(" sudo ssh -o StrictHostKeyChecking=no -i /root/Downloads/2ndjune.pem ec2-user@"+pi+' sudo -i hdfs dfs -ls -R /')
	print kk
	print '</pre>'
