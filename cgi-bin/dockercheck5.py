...
def one():
	print '<pre>'
	print commands.getoutput(" sudo docker exec "+di+" hadoop fs -mkdir /sample")
...
def two():
	print "oo"
	print '<form method="post" action="/cgi-bin/dockercheckfunction2.py">'
...
def three():
	print "oo"
	print '<form method="post" action="/cgi-bin/dockercheckfunction3.py">'
	print '<b>Enter the location of file to upload :</b>'
	print '<label><input type="text" name="1"></label>'
	print '<br><b>Enter the location to upload: </b>'	
	print '<label><input type="text" name="2"></label>'
	print '<br><b>Enter the replication size: </b>'	
...
def four():
	...
	print '<pre>'
	print commands.getoutput(" sudo docker exec "+di+" hadoop dfsadmin -safemode enter")
...
def five():
	print "oo"
	print '<form method="post" action="/cgi-bin/dockercheckfunction5.py">'
...
def six():
	print "oo"
	print '<form method="post" action="/cgi-bin/dockercheckfunction6.py">'
...
def seven():
	print "oo"
	print '<form method="post" action="/cgi-bin/dockercheckfunction7.py">'
...
def eight():
	print "oo"
	print '<form method="post" action="/cgi-bin/dockercheckfunction8.py">'
	print '<b>Enter the location of the directory whose quota you want to free : </b>'
	print '<label><input type="text" name="1"></label>'
	print '<label><input type="submit" value="Click to set"></label>'
	print '</form>'
...
def nine():
	print "oo"
	print '<form method="post" action="/cgi-bin/dockercheckfunction9.py">'
...
def ten():
	print '<pre>'
	print commands.getoutput(" sudo docker exec "+di+" hadoop fs -lsr /")
	#kk=commands.getoutput(" sshpass -p 'q' ssh -o StrictHostKeyChecking=no root@" +pi+' sudo hadoop fs -lsr /')
	#print kk
	print '</pre>'
