...
<body>
<div class="container">
<h1><span style="color:green"><u>FILL THE DETAILS</u>:-</span></h1>
<p></p>
'''
print yyy
...
def one():
	#print "oo"
	print '<form method="post" action="/cgi-bin/dockercheckmapfunction1.py">'
	print '<b>Enter the loaction of uploaded file on ehich you have to do wordcount :</b>'
	print '<label><input style="color: grey;font-family: Serif;font-size: 100% " type="text" name="1"></label>'
	print '<br><b>Enter the location where you want to store the output : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b>'	
	print '<label><input style="color: grey;font-family: Serif;font-size: 100% " type="text" name="2"></label>'
	print '<label><input type="submit" value="Click to process"></label>'
	print '</form>'
	#print '<pre>'
	#print commands.getoutput(" sshpass -p 'q' ssh -o StrictHostKeyChecking=no root@" +pi+' jps')
	#print commands.getoutput(" sshpass -p 'q' ssh -o StrictHostKeyChecking=no root@" +pi+' sudo hadoop jar /usr/share/hadoop/hadoop-examples-1.2.1.jar wordcount /uu.py /411')
	#print commands.getoutput(" sshpass -p 'q' ssh -o StrictHostKeyChecking=no root@" +pi+' sudo hadoop dfs -cat /uu.py')
	#print commands.getoutput(" sshpass -p 'q' ssh -o StrictHostKeyChecking=no root@" +pi+' sudo hadoop dfs -cat /411/part-r-00000')
	#print '</pre>'
